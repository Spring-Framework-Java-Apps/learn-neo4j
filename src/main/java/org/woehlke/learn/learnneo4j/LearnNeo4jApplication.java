...
import org.woehlke.learn.learnneo4j.components.CategoryRepository;

//@EnableNeo4jRepositories("org.woehlke.learn.learnneo4j.components")
//@EnableTransactionManagement
//@ComponentScan("org.woehlke.learn.learnneo4j.components")
...
public class LearnNeo4jApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		System.out.println("--------------------------------");
		System.out.println(this.categoryRepository.findByCategory("www"));
